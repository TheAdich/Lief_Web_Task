...
useEffect(() => {
    ...
    return (
        <div className="w-3/4 mx-auto p-6 mt-10 bg-opacity-30 bg-slate-200 rounded-xl shadow-xl backdrop-blur-md">
           <h1 className="text-2xl font-extrabold text-blue-700 mb-6 text-right">Accident Data Form</h1>
<p className="font-light text-xs text-green-400">Complete the form thoroughly</p>
